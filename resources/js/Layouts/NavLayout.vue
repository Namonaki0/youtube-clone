...
<template>
    <div class="relative">
        <div
            id="TopNav"
            class="fixed bg-black z-20 flex items-center justify-between w-[100%] h-[60px]"
        >
            <div class="flex items-center">
                <button
                    class="p-2 ml-3 rounded-full hover:gb-gray-800 inline-block cursor-pointer"
                    @click="isNavOverlay()"
                >
                ...
                >
                    ...
                    />
                    <img
                        src="/images/YT-logo-text.png"
                        alt="youtube text logo"
                        width="62"
                    />
                </Link>
            </div>
            ...
            <div>
                <img
                    src="https://yt3.ggpht.com/yti/AOXPAcVAQCLjh-LCps_4yIjWiDQm8uAz-tBnzBh7Rg=s88-c-k-c0x00ffffff-no-rj-mo"
                    alt="profile image"
        ...
        <div>
            ...
            >
                <div class="flex items-center">
                    <button
                        class="p-2 ml-3 rounded-full hover:gb-gray-800 cursor-pointer"
                        @click="isNavOverlay()"
                    >
                        <MenuIcon fillColor="#FFFFFF" :size="26" />
                    </button>
                    <div class="mx-2"></div>
                    <div
                        class="text-white flex items-center justify-center mr-10 cursor-pointer"
                    >
                        <Link
                            class="flex items-center justify-center text-white mr-10 cursor-pointer"
                            :href="route('home')"
